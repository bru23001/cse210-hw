...
The data type for the reference is Reference, the custom class defined above. The data type for the 
list of words would be List<Word> (notice it is a list of Word objects, rather than a list of strings.)
○ _reference : Reference
○ _words : List<Word>

🙄 CONSTRUCTORS: need a constructor that accepts both a reference and the text of the scripture. 
